...
# models = ('HovorkaAbsolute-v0')
# models = ('CambridgeAbsolute-v0','CambridgeBinary-v0', 'CambridgeGaussian-v0', 'CambridgeGaussianInsulin-v0')

folder_prefix = '/home/jonas/Dropbox/results/hovorka_cgm_higher_max_bg'

# Hack to avoid problems -- only first is used
...
for k in range(len(models)):
    ...
    for i in range(1):
        ...
        log_dir = folder_prefix + RL + '/' + NN_folder + '/' + RL + models[k]
        ...
        ## Testing the policy
        data_dir = folder_prefix + RL + '/' + NN_folder + '/' + RL + models[k]
